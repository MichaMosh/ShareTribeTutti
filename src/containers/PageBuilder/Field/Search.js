...
function Search() {
    ...
    const handleSearchClick = () => {
      var basicUrl = '/s?address=Maui%2C%20Hawaii%2C%20USA&bounds=21.03141298976477%2C-155.9790420834986%2C20.57457850828407%2C-156.6969232882344'
      ...
      if(category && category !== '') {
        basicUrl += `&pub_category=${category}`
      }
      if (selectedDate) {
        const formattedDate = formatDate(selectedDate);
        // Append the dates query parameter
    ...
    return (
      <section style={{ display: 'flex', alignItems: 'center', zIndex: 1000, marginTop: '50px' }}>
        ...
        >
          ...
          <option value="activities">Sport Activities</option>
